# Stuff - Single prompt request - Cost efficient
# Refine documents chain - Multiple document 
# Map reduce
# Map rerank chain

# TBD save to the DB -> Embed to Mongo
# TBD - Retrieval logic
# TBD connection to FE

# YouTubeProcessor
# https://www.youtube.com/watch?v=OTL4CvDFlro&list=LL
...
Helpful Answer:"""
        ...
        # Combine documents through reducer chain
        ...
        # Summarize each document on it's own in a "map" step and then "reduce" the summaries into a final summary
